...
if __name__ == '__main__':
  ...
  DATA_REFRESH_RATE = 0.03 #seconds. This is the refresh rate of predictions
  ...
  update_dummyests_thread = Thread(target=GUIapp.update_dummyests, args=[['stall', 'state', 'liftdrag', 'mfc']])
  ...
  print ("Dummy estimates update started.")
  ...
  data_stream.start()
  print ("Data stream server started.")
